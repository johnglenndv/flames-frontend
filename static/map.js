...
/*nodesData.forEach(function(node) {
    ...
    marker.on('click', function(e) {
        ...
        statusContent.innerHTML = `
            <p style="justify-content: space-between; text-align: left;">Location: <span class="val">${node.name}</span></p>
            <p style="justify-content: space-between; text-align: left;">Temperature: <span class="val">${node.temp}</span></p>
            <p style="justify-content: space-between; text-align: left;">Humidity: <span class="val">${node.humidity}</span></p>
            <p style="justify-content: space-between; text-align: left;">Smoke: <span class="val">${node.smoke}</span></p>
            <p style="justify-content: space-between; text-align: left;">Flame: <span class="val">${node.flame}</span></p>
        `;
    });
});
*/
